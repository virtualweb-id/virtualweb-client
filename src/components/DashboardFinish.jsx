...
const DashboardFinish = () => {
  ...
  return (
    <>
      ...
      <div className="md:w-1/2 m-3 py-2 h-1/2 md:h-full max-w-xl  rounded overflow-hidden">
        ...
        <div className="md:w-1/2 m-3 flex justify-center h-1/2 md:h-full">
          ...
          <table cellpadding="0" cellspacing="0" border="0" width="600" align="center" class="ExternalClass">
            ...
            <tr>
              ...
              <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color:#b3965a; justify-content: center; align-items: center;">
                ...
                <tr>
                  <td style="font-size:16px; color:#92763d; font-weight:700; text-align: center; text-transform: uppercase;  word-spacing:4px; letter-spacing: 5px;">wedding date</td>
                </tr>
                <tr>
            ...
            <tr>
              ...
              <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color:#212121; justify-content: center; align-items: center;">
                ...
                <tr>
                  <td style="font-size:20px; color:#fff; font-family: 'Montserrat', sans-serif, Arial, Helvetica; font-weight:400; text-align:center; text-transform: uppercase; letter-spacing: 5px;">guest name</td>
                </tr>
                <tr>
                  <td height="30"><img border="0"  src="images/spacer.gif" height="1" width="1" alt="" title="" /></td>
                </tr>
                <tr>
                  <td style="font-size:18px; color:#fff; font-family: 'Montserrat', sans-serif, Arial, Helvetica; font-weight:400; text-align:center; text-transform: uppercase; letter-spacing: 5px;">Your Guest ID: 38928192 </td>
                </tr>
                <tr>
            ...
            <tr>
              ...
              <td height="26"><img border="0"  src="images/spacer.gif" height="1" width="1" alt="" title="" /></td>
                ...
                <tr>
                  <td style="font-size:21px; font-family: 'Montserrat', sans-serif, Arial, Helvetica; font-weight:400; text-align:center; text-transform: uppercase; letter-spacing: 5px;"><p style="color:#ffe05d;">>> CONFIRMATION  <<</p></td>
                </tr>
              </table></td>
            </tr>
