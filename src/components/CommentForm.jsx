    ...
    const onSubmit = () => {
        if (!inputComment.name || !inputComment.relationship || !inputComment.message) {
          ...
          setInputComment({
            ...
            console.log(InvitationId, "<< ini id di form body")
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-2 gap-4 max-w-xl m-auto">
                ...
                <input type="text" name='name' onChange={handleOnChange} className="border-solid border-gray-200 border-2 p-3 md:text-xl w-full" placeholder="Name"/>
                </div>

                <div className="col-span-2 lg:col-span-1">
                <input type="text" name='relationship' onChange={handleOnChange} className="border-solid border-gray-200 border-2 p-3 md:text-xl w-full" placeholder="Relationship"/>
                </div>

                <div className="col-span-2">
                <textarea cols="30" name='message' onChange={handleOnChange} rows="8" className="border-solid border-gray-200 border-2 p-3 md:text-xl w-full" placeholder="Message"></textarea>
                </div>
