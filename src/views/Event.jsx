      ...
      return (
        <>
          <div className="relative pt-16 pb-32 flex content-center items-center justify-center "
            ...
            <p className="text-white text-3xl tallfont">{moment(holder.date).format("MMM Do YY")}</p>
          </div>
          </div>
      ...
      style={{ backgroundImage: `url(${bunga})`, maxHeight: '1000px' }}>
         ...
         <div className="body-font text-gray-600">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill={holder.backgroundColor} fill-opacity="1" d="M0,96L60,90.7C120,85,240,75,360,80C480,85,600,107,720,122.7C840,139,960,149,1080,154.7C1200,160,1320,160,1380,160L1440,160L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"></path></svg>
                ...
                <div className="w-full md:flex-row flex-col my-20 flex text-2xl flex-wrap justify-center" style={{ }}>
              <img
                  alt="..."
                  className=" h-full md:w-1/2 w-screen"
                  src={holder.additionalImg}
                  style={{}}
                />
                <div className="flex flex-col md:w-1/2 w-full justify-center items-center tallfont font-bold md:my-0 py-10 md:rounded-none rounded"
                style={{backgroundColor: holder.textColor, color: holder.backgroundColor }}>
                  ...
                  <SlideCountdown
                    weeks={false}
                    deadline={holder.date} />
                  <p className="m-3">{moment(holder.date).format("MMM Do YY")}</p>
                  <p className="m-3"><svg className="w-6 h-6 inline" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" /></svg>{holder.address}</p>
